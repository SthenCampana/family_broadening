...
# python family_on_demand_gen.py -n1 sym_family.nx -n2 sym_family.nx -p1 sym_family_profiles.txt -p2 sym_family_profiles.txt -o sym_joint
#example python family_on_demand_gen.py -n1 testfam_half.nx -n2 testfam_half.nx -p1 test_fam_profilev2.txt -p2 test_fam_profilev2.txt -s 3
# python family_on_demand_gen.py -n1 main_sim.nx -n2 fam0.nx -p1 main_sim_profiles.txt -p2 fam0_profiles.txt -o sym_joint -cf 9
